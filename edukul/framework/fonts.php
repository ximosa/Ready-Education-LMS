...
function edukul_standard_fonts() {
	return array(
...
function edukul_google_fonts_array() {
...
function edukul_enqueue_google_font( $font ) {

	// Get list of all Google Fonts
	$google_fonts = edukul_google_fonts_array();
	...
	// Subset
	$subset = edukul_get_mod( 'google_font_subsets', 'latin' );
	$subset = $subset ? $subset : 'latin';
	$subset = '&amp;subset='. $subset;

	// Weights
	$weights = array( '100', '200', '300', '400', '500', '600', '700', '800', '900' );
	$weights = apply_filters( 'edukul_google_font_enqueue_weights', $weights, $font );
	$italics = apply_filters( 'edukul_google_font_enqueue_italics', true );

	// Main URL
	$url = edukul_get_google_fonts_url() .'/css?family='. str_replace(' ', '%20', $font ) .':';
	...
	// Enqueue style
	wp_enqueue_style( 'edukul-google-font-'. $handle, $url, false, false, 'all' );
}